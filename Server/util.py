...
def load_saved_artifacts():
    ...
    with open("C:/Users/USER/Desktop/Machine_learning/Image_Recognition_Model_Project/Server/Artifacts/class_dictionary.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open('C:/Users/USER/Desktop/Machine_learning/Image_Recognition_Model_Project/Server/Artifacts/saved_model.pkl', 'rb') as f:
